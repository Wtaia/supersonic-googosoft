...
export default defineConfig({
  define: {
    ...
    'process.env': {
      ...process.env,
      API_BASE_URL: '/webapp/api/semantic/', // 直接在define中挂载裸露的全局变量还需要配置eslint，ts相关配置才能导致在使用中不会飘红，冗余较高，这里挂在进程环境下
      CHAT_API_BASE_URL: '/webapp/api/chat/',
      AUTH_API_BASE_URL: '/webapp/api/auth/',
      SHOW_TAG: false,
      ...ENV_CONFIG,
    },
  },
